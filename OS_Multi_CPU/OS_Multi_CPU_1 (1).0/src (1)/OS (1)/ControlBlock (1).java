...
public class ControlBlock implements Comparable<ControlBlock>{
    ...
    private Integer programCounter;         //JOB ID
    private int codeSize;                //JOB  size
    private int priority;                    //JOB level
    private int inputBuffer;                //DATA input buffer size
    private int outputBufferSize;        //DATA  output buffer size
    private int tempBufferSize;        //DATA  temporary buffer size
    ...
    private int PercenetageofRamUsed;
    ...
    public void setPercenetageofRamUsed(int percenetageofRamUsed) {
        PercenetageofRamUsed = percenetageofRamUsed;
    }

    public int getPercenetageofRamUsed() {
