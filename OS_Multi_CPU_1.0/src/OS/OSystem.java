...
public class OSystem {
  ...
  //  }
    ...
    public void stopT() {// created because stop from the
        // Thread Library wasn't working? or maybe something else
        setRunning(false);

       OSystem.getInstance().setSimStopTime(System.currentTimeMillis());
    }
    ...
    public void setSimStopTime(long simStopTime) {
