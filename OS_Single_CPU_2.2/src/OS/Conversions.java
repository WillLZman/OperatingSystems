...
public class Conversions {
    ...
    public String HexToBinary(String s){
        return String.format("%8s", Integer.toBinaryString(Integer.valueOf(s)).replace(' ', '0'));
    }
        ...
        if (hexArray.length == 0) {
            ...
            switch (value) {
                ...
                default:
                    ...
                    System.out.println("See hexBinaryHelper()");
    ...
    public static String getFileAsString(File file, Charset encoding) {
